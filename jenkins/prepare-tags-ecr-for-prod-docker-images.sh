# burada mysql tag i yok. Cünkü bu asamada AWS RDS kullanacagiz database icin. Bu nedenle mysql ile ilgili tag hazirlamadik
# daha önceki tag leme scriptleri ile diger kisimlari ayni
# bu script ile tag lerimizi dynamic bir sekilde olusturmus oluyoruz
# hard coding yerine dynamic coding kullanmis oluyoruz
